...
final class HtmlView extends BaseHtmlView
{
	...
	private function addToolbar(): void
	{
		...
		ToolbarHelper::title(Text::_($isNew ? 'COM_JOOMLEAGUE_CLUB_NEW' : 'COM_JOOMLEAGUE_CLUB_EDIT'), 'shield');
		if ($user->authorise('core.edit', 'com_joomleague') || ($isNew && $user->authorise('core.create', 'com_joomleague'))) {
			...
			if ($user->authorise('core.create', 'com_joomleague')) ToolbarHelper::save2new('club.save2new');
		}
