...
return new class implements ServiceProviderInterface{public function register(Container$c):void{$c->registerServiceProvider(new ModuleDispatcherFactory('\\Joomleague\\Module\\Eventranking'));$c->registerServiceProvider(new HelperFactory('\\Joomleague\\Module\\Eventranking\\Site\\Helper'));$c->registerServiceProvider(new Module());}};
