...
final class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		if (Factory::getApplication()->getIdentity()->authorise($isNew ? 'core.create' : 'core.edit', 'com_joomleague')) { ToolbarHelper::apply('standingadjustment.apply'); ToolbarHelper::save('standingadjustment.save'); ToolbarHelper::save2new('standingadjustment.save2new'); }
