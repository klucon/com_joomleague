...
final class ParticipantHelper
{
	...
	public function getSummary(Registry $params): array
	{
		...
		try { $data = (new ParticipantSummaryReader(Factory::getContainer()->get(DatabaseInterface::class)))->read($projectId, $entryId, $app->getIdentity()->getAuthorisedViewLevels(), Factory::getDate()->format('Y-m-d')); }
