...
<?php else : $participant=$summary['participant']; $media=$participant->team_logo ?: ($participant->person_picture ?: $participant->team_picture); $showPersonalData=(bool)($summary['template_config']['show_personal_data']??true); $showResults=(bool)($summary['template_config']['show_results']??true); ?>
<article class="card"><div class="card-body">
	<div class="d-flex gap-3 align-items-start">
		<?php if ($showPersonalData && (bool)$params->get('show_image',1) && $media) : ?><img src="<?php echo htmlspecialchars((string)$media,ENT_QUOTES,'UTF-8'); ?>" alt="" class="img-fluid" width="72" height="72" loading="lazy"><?php endif; ?>
