...
final class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$canEditResults = $user->authorise('joomleague.project.edit.results', $asset);
		if ($canEditResults) ToolbarHelper::addNew('standingadjustment.add');
		if ($this->items !== [] && $canEditResults) { ToolbarHelper::editList('standingadjustment.edit'); ToolbarHelper::publish('standingadjustments.publish', 'JTOOLBAR_PUBLISH', true); ToolbarHelper::unpublish('standingadjustments.unpublish', 'JTOOLBAR_UNPUBLISH', true); ToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'standingadjustments.delete'); }
