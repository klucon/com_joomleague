...
final class HtmlView extends BaseHtmlView
{
	...
	private function addToolbar(): void
	{
		...
		if ($this->items !== [] && $user->authorise('core.edit', 'com_joomleague')) ToolbarHelper::editList('venue.edit');
		...
		if ($this->items !== [] && $user->authorise('core.delete', 'com_joomleague')) ToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'venues.delete');
	}
}
