...
final class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		if ($user->authorise('core.edit', $asset)) ToolbarHelper::editList('stage.edit');
		if ($user->authorise('core.edit.state', $asset)) { ToolbarHelper::publish('stages.publish', 'JTOOLBAR_PUBLISH', true); ToolbarHelper::unpublish('stages.unpublish', 'JTOOLBAR_UNPUBLISH', true); ToolbarHelper::checkin('stages.checkin'); }
		if ($user->authorise('core.delete', $asset)) ToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'stages.delete');
