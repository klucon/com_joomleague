...
foreach (['UuidFactory.php', 'EntryModelValidator.php', 'MatchEventRepository.php'] as $service) require_once JPATH_ADMINISTRATOR . '/components/com_joomleague/src/Service/' . $service;
...
$people = [];
foreach (['Primary', 'Second', 'Opponent'] as $personName) $people[] = $insert('#__joomleague_person', ['uuid' => $uuid(), 'first_name' => $personName, 'last_name' => $name]);
