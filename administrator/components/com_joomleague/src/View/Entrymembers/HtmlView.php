...
final class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		if ($this->canEdit) ToolbarHelper::editList('entrymember.edit');
		if ($user->authorise('core.delete', $asset)) ToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'entrymembers.delete');
