...
{
	protected string $entityName = 'teamplayer';
	...
	protected function prepareTable($table): void
	{
		...
		foreach (['projectteam_id', 'person_id', 'project_position_id', 'jerseynumber', 'active', 'injury', 'suspension', 'away', 'published'] as $field) {
