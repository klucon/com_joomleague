...
final class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		if ($canEditSchedule) { ToolbarHelper::link('index.php?option=com_joomleague&view=scheduleplanner&stage_id=' . (int) $this->stage->id, 'COM_JOOMLEAGUE_SCHEDULE_GENERATE', 'calendar'); ToolbarHelper::addNew('round.add'); }
		if ($this->items !== [] && $canEditSchedule) { ToolbarHelper::editList('round.edit'); ToolbarHelper::publish('rounds.publish', 'JTOOLBAR_PUBLISH', true); ToolbarHelper::unpublish('rounds.unpublish', 'JTOOLBAR_UNPUBLISH', true); ToolbarHelper::checkin('rounds.checkin'); ToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'rounds.delete'); }
