	...
	<?php else : ?>
		...
		<?php else : ?>
			...
			<?php if ($nextMatch !== null) : ?>
				<a class="card text-bg-primary bg-gradient shadow-sm mb-4 text-decoration-none" href="<?php echo Route::_('index.php?option=com_joomleague&amp;view=programitem&amp;match_id=' . (int) $nextMatch['match_id']); ?>">
					<div class="card-body">
			...
			$renderCards = function (array $rows, string $sectionTitle, string $sectionIcon) use ($teamsMarkup, $formatScore, $formatDateTime, $outcome, $plan) {
				...
				<div class="row row-cols-1 row-cols-md-2 g-3 mb-3">
					<?php foreach ($rows as $match) :
						...
						?>
						<div class="col">
							<a class="card h-100 shadow-sm border-start border-4 border-<?php echo $borderColor; ?> text-decoration-none text-body" href="<?php echo Route::_('index.php?option=com_joomleague&amp;view=programitem&amp;match_id=' . (int) $match['match_id']); ?>">
								<div class="card-body">
