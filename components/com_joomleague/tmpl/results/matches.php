...
<?php else : ?>
	<div class="table-responsive">
		<table class="table jl-site-table align-middle">
			<thead><tr><th><?php echo Text::_('COM_JOOMLEAGUE_SITE_DATE'); ?></th><th><?php echo Text::_('COM_JOOMLEAGUE_SITE_ROUND'); ?></th><th><?php echo Text::_('COM_JOOMLEAGUE_SITE_HOME'); ?></th><th><?php echo Text::_('COM_JOOMLEAGUE_SITE_SCORE'); ?></th><th><?php echo Text::_('COM_JOOMLEAGUE_SITE_AWAY'); ?></th><th><?php echo Text::_('COM_JOOMLEAGUE_SITE_PLAYGROUND'); ?></th><th></th></tr></thead>
			<tbody>
				<?php foreach ($this->matches as $match) : ?>
					<tr>
						...
						<td><?php echo $this->escape($match->playground_name ?? ''); ?></td>
