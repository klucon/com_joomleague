...
namespace Joomleague\Component\Joomleague\Administrator\View\Person;
...
final class HtmlView extends BaseHtmlView
{
	...
	private function addToolbar(): void
	{
		...
		ToolbarHelper::title(Text::_($isNew ? 'COM_JOOMLEAGUE_PERSON_NEW' : 'COM_JOOMLEAGUE_PERSON_EDIT'), 'user');
		if ($user->authorise('core.edit', 'com_joomleague') || ($isNew && $user->authorise('core.create', 'com_joomleague'))) {
			...
			if ($user->authorise('core.create', 'com_joomleague')) ToolbarHelper::save2new('person.save2new');
		}
