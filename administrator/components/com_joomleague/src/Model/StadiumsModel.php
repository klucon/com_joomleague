...
final class StadiumsModel extends ListModel
{
	public function __construct($config = [], ?MVCFactoryInterface $factory = null)
	{
		$config['filter_fields'] ??= ['id', 'a.id', 'name', 'a.name', 'city', 'a.city', 'club', 'club.name', 'ordering', 'a.ordering'];
	...
	protected function getListQuery(): QueryInterface
	{
		...
		$query = $db->createQuery()->select([
			...
			->join('LEFT', $db->quoteName('#__joomleague_club', 'club'), $db->quoteName('club.id') . ' = ' . $db->quoteName('a.club_id'))
